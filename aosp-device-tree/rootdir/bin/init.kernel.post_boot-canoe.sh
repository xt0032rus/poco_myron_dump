...
case "$variant" in
	"6_2")
		/vendor/bin/sh /vendor/bin/init.kernel.post_boot-canoe_default_6_2.sh
		;;
	"6_1")
		/vendor/bin/sh /vendor/bin/init.kernel.post_boot-canoe_6_1.sh
		;;
	"5_1")
		/vendor/bin/sh /vendor/bin/init.kernel.post_boot-canoe_5_1.sh
		;;
	"5_2")
		/vendor/bin/sh /vendor/bin/init.kernel.post_boot-canoe_5_2.sh
		;;
	*)
